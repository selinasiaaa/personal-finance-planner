...
describe('Goal unit tests - financialEngine', () => {
  test('UT-16: parseDateLabel returns correct Date for YYYY-MM', () => {
  ...
  test('UT-17: calcProgressPercent computes percentage correctly', () => {
  ...
  test('UT-18: calcProjectedSavings sums savings and monthly*months', () => {
    expect(calcProjectedSavings(100, 50, 3)).toBe(250);
  });

  test('UT-19: calcStatus returns expected categories', () => {
    // completed
  ...
  test('UT-20: calcAdvisoryInputs returns options when deficit exists', () => {
