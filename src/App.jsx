...
const Sidebar = ({ currentPage, user, isAuthPage }) => {
  ...
  // Profile removed from nav — accessed via avatar click
  const navItems = [
  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-footer">
        {/* Clickable user block → navigates to profile */}
        <button
          onClick={() => navigate('/profile')}
          className={`sidebar-user-btn ${currentPage === 'profile' ? 'active' : ''}`}
          style={{
            display: 'flex', alignItems: 'center', gap: '10px',
            width: '100%', background: currentPage === 'profile' ? 'var(--blue-light)' : 'none',
          ...
          onMouseLeave={e => { if (currentPage !== 'profile') e.currentTarget.style.background = 'none'; }}
          title="View Profile"
        >
...
const LoginPage = () => {
  ...
  useEffect(() => {
    if (getStoredUser()?.email) navigate('/');
  }, [navigate]);
        ...
        <div className="auth-card">
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <div className="d-flex gap-3 mt-3">
              ...
              <button type="submit" className="btn-modal-save" style={{ flex: 1 }} disabled={loading}>
                {loading ? 'Saving...' : 'Save'}
              </button>
            </div>
          </form>
      ...
      <div className="page-header d-flex align-items-center justify-content-between mb-4">
        ...
        <button
          ...
          style={{
            ...
            cursor: 'pointer', fontWeight: 700, fontFamily: 'var(--font-b)',
            fontSize: '.9rem', transition: 'background .2s',
          }}
      ...
      <div className="row g-3">
        ...
        <div className="col-md-8">
          <div style={{
            ...
            borderRadius: 'var(--r-card)', padding: '24px', boxShadow: 'var(--shadow)',
          }}>
            <h5 style={{ fontFamily: 'var(--font-h)', fontSize: '1.1rem', marginBottom: '20px', color: 'var(--text-dark)' }}>
              Profile Information
            </h5>
            ...
            <form onSubmit={handleSubmit}>
              {/* Full Name */}
              <div className="mb-3">
                <label className="form-label" style={{ fontWeight: 500, color: 'var(--text-dark)' }}>Full Name</label>
                <input
                  type="text" style={inputStyle} value={profileData.name} required
              ...
              {/* Email */}
              <div className="mb-3">
                <label className="form-label" style={{ fontWeight: 500, color: 'var(--text-dark)' }}>Email</label>
                <input
                  type="email" style={inputStyle} value={profileData.email} required
              ...
              {/* Phone */}
              <div className="mb-3">
                <label className="form-label" style={{ fontWeight: 500, color: 'var(--text-dark)' }}>Phone Number</label>
                <input
                  type="tel" style={inputStyle} value={profileData.phone}
              ...
              {/* Date of Birth */}
              <div className="mb-3">
                <label className="form-label" style={{ fontWeight: 500, color: 'var(--text-dark)' }}>Date of Birth</label>
                <input
                  type="date" style={inputStyle} value={profileData.dob}
              ...
              {/* Occupation */}
              <div className="mb-3">
                <label className="form-label" style={{ fontWeight: 500, color: 'var(--text-dark)' }}>Occupation</label>
                <input
                  type="text" style={inputStyle} value={profileData.occupation}
              ...
              {/* Address */}
              <div className="mb-3">
                <label className="form-label" style={{ fontWeight: 500, color: 'var(--text-dark)' }}>Address</label>
                <input
                  type="text" style={inputStyle} value={profileData.address}
              ...
              <div className="row mb-3">
                <div className="col-md-6 mb-3 mb-md-0">
                  <label className="form-label" style={{ fontWeight: 500, color: 'var(--text-dark)' }}>City</label>
                  <input
                    type="text" style={inputStyle} value={profileData.city}
                ...
                <div className="col-md-6">
                  <label className="form-label" style={{ fontWeight: 500, color: 'var(--text-dark)' }}>Country</label>
                  <input
                    type="text" style={inputStyle} value={profileData.country}
              ...
              <button
                ...
                disabled={loading}
                style={{ borderRadius: 'var(--r-sm)', padding: '10px 24px' }}
              >
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                border: 'none', padding: '12px 16px', borderRadius: 'var(--r-sm)',
                cursor: 'pointer', fontWeight: 700, fontFamily: 'var(--font-b)',
                fontSize: '.9rem', marginBottom: '12px', transition: 'background .2s',
              }}
...
const GoalsPage = ({ user }) => {
  ...
  const [formData, setFormData] = useState({
    icon: '🏠', name: '', desc: '', target: '', savings: '', monthly: '', dateLabel: '',
  });
  ...
  return (
    <div className="main-content">
      ...
      {/* ── GOAL CARDS GRID ── */}
      <div className="row g-3" id="goalsGrid">
        {filteredGoals.map(goal => (
          <div key={goal.id} className="col-12 col-md-6 col-xl-4">
              ...
              <div className="goal-meta">
                <div className="meta-row">
                  ...
                  <div className="goal-actions">
                    {goal.hasAI && (
                      <button className="action-btn" title="AI Advisory" onClick={() => { setSelectedOption(null); setShowAIModal(true); }}
                        style={{ color: '#6366f1' }}>
          ...
          <div style={{ background: 'white', borderRadius: '22px', maxWidth: '560px', width: '90%', maxHeight: '90vh', overflowY: 'auto', boxShadow: '0 24px 64px rgba(59,110,255,.18)' }}>
            ...
            <div style={{ padding: '24px 26px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '24px' }}>
                {/* Option A */}
                <div onClick={() => setSelectedOption('A')} style={{ border: `1.5px solid ${selectedOption === 'A' ? '#3b6eff' : '#e2e6f0'}`, borderRadius: '16px', padding: '16px', cursor: 'pointer', boxShadow: selectedOption === 'A' ? '0 0 0 3px rgba(59,110,255,.15)' : 'none', minHeight: '190px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                    <span style={{ fontSize: '.72rem', fontWeight: 700, color: '#3b6eff' }}>Option A – TIME</span>
                    <div style={{ width: 18, height: 18, borderRadius: '50%', border: `2px solid ${selectedOption === 'A' ? '#3b6eff' : '#e2e6f0'}`, background: selectedOption === 'A' ? 'radial-gradient(circle at center, #3b6eff 45%, #fff 45%)' : 'transparent' }}></div>
                  </div>
                  <div style={{ fontFamily: 'Sora, sans-serif', fontSize: '1.6rem', fontWeight: 800, margin: '6px 0' }}>+42 <span style={{ fontSize: '.9rem', fontWeight: 500, color: '#5c6170' }}>months</span></div>
                  <p style={{ fontSize: '.76rem', color: '#5c6170', lineHeight: 1.4, margin: '0 0 10px' }}>Keep saving RM 2,100/month and extend your deadline by 3 years 6 months</p>
                  <span style={{ display: 'inline-block', background: '#f3f5f9', color: '#5c6170', fontSize: '.72rem', fontWeight: 600, borderRadius: '99px', padding: '3px 10px' }}>Retire by Sep 2058</span>
                </div>

                {/* Option B */}
                <div onClick={() => setSelectedOption('B')} style={{ border: `1.5px solid ${selectedOption === 'B' ? '#3b6eff' : '#e2e6f0'}`, borderRadius: '16px', padding: '16px', cursor: 'pointer', boxShadow: selectedOption === 'B' ? '0 0 0 3px rgba(59,110,255,.15)' : 'none', minHeight: '190px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                    <span style={{ fontSize: '.72rem', fontWeight: 700, color: '#22c55e' }}>Option B – AMOUNT</span>
                    <div style={{ width: 18, height: 18, borderRadius: '50%', border: `2px solid ${selectedOption === 'B' ? '#3b6eff' : '#e2e6f0'}`, background: selectedOption === 'B' ? 'radial-gradient(circle at center, #3b6eff 45%, #fff 45%)' : 'transparent' }}></div>
                  </div>
                  <div style={{ fontFamily: 'Sora, sans-serif', fontSize: '1.6rem', fontWeight: 800, margin: '6px 0' }}>+RM252<span style={{ fontSize: '.9rem', fontWeight: 500, color: '#5c6170' }}>/mo</span></div>
                  <p style={{ fontSize: '.76rem', color: '#5c6170', lineHeight: 1.4, margin: '0 0 10px' }}>Increase to RM 2,352/month and hit your original March 2055 goal</p>
                  <span style={{ display: 'inline-block', background: '#dcfce7', color: '#15803d', fontSize: '.72rem', fontWeight: 600, borderRadius: '99px', padding: '3px 10px' }}>Stay on track for 2055</span>
                </div>
              </div>
              ...
              <div style={{ background: '#f0f4ff', borderRadius: '12px', padding: '16px' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    <div style={{ width: 36, height: 36, borderRadius: '50%', background: '#3b6eff', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '.9rem' }}>✦</div>
                    <div>
                      <p style={{ fontWeight: 700, fontSize: '.85rem', color: '#1a1d2e', margin: 0 }}>WealthTrack AI Advisor</p>
                      <p style={{ fontSize: '.72rem', color: '#9ca3af', margin: 0 }}>Powered by Gemini · Smart Suggestions · Feature 3.4</p>
                    </div>
                  </div>
                ...
                <p style={{ fontSize: '.84rem', lineHeight: 1.6, color: '#1a1d2e', margin: '0 0 12px' }}>
                  You're already <strong>RM 210,000</strong> into your retirement journey — that's a real foundation to build on. If your monthly savings stay at <strong>RM 2,100</strong>, you'd reach your goal by <span style={{ color: '#3b6eff', fontWeight: 700 }}>Sep 2058</span> — about 3 years and 6 months later than planned. Alternatively, adding just <span style={{ color: '#22c55e', fontWeight: 700, background: '#dcfce7', borderRadius: 4, padding: '1px 5px' }}>+RM 252/month</span> (total RM 2,352/month) keeps your original March 2055 retirement fully intact.
                </p>
                <div style={{ background: '#fff', borderRadius: '8px', padding: '10px 12px', display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
                  <span style={{ fontSize: '1rem' }}>💡</span>
                  <p style={{ fontSize: '.78rem', color: '#5c6170', lineHeight: 1.45, margin: 0 }}>Automating your monthly transfer to a separate investment account removes the temptation to skip — consistency compounds faster than any single large contribution.</p>
                </div>
              </div>

              {/* Action buttons */}
              <div style={{ display: 'flex', gap: '8px', marginTop: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
                <button style={{ border: '1.5px solid #e2e6f0', background: '#fff', borderRadius: '99px', padding: '8px 16px', fontFamily: 'DM Sans, sans-serif', fontSize: '.84rem', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '5px' }}>↻ Regenerate</button>
        ...
        <div style={{ background: 'white', borderRadius: '22px', padding: '32px', maxWidth: '560px', width: '90%', maxHeight: '90vh', overflowY: 'auto', boxShadow: '0 24px 64px rgba(59,110,255,.18)' }}>
          ...
          <form onSubmit={handleSaveGoal}>
            ...
            <div className="modal-field">
              ...
              <input className="modal-input-field" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} placeholder="e.g. Dream Vacation Fund" />
            </div>

            <div className="modal-field">
              <label className="modal-label">Description</label>
              <input className="modal-input-field" value={formData.desc} onChange={(e) => setFormData({ ...formData, desc: e.target.value })} placeholder="Brief description of this goal" />
            </div>

            {/* Target Amount + Current Savings side by side */}
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
              <div className="modal-field">
                <label className="modal-label">Target Amount</label>
                <input className="modal-input-field" value={formData.target} onChange={(e) => setFormData({ ...formData, target: e.target.value })} placeholder="RM50,000" />
              </div>
              <div className="modal-field">
                <label className="modal-label">Current Savings</label>
                <input className="modal-input-field" value={formData.savings} onChange={(e) => setFormData({ ...formData, savings: e.target.value })} placeholder="RM0" />
              </div>
            </div>
            ...
            {/* Target Date + Category side by side */}
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
              <div className="modal-field">
      ...
      <div className="inv-container">
        ...
        <div className="risk-tabs mb-4">
          {['conservative', 'balanced', 'aggressive'].map(risk => (
            <button
              key={risk}
              className={`risk-tab ${selectedRisk === risk ? 'active ' + risk : ''}`}
        ...
        {/* Top row: Asset Allocation + Recommended Instruments */}
            ...
            <div className="inv-info-card">
              ...
              <div className="alloc-bar mb-2">
                {riskData.allocation.map((a, i) => (
                  <div key={i} className="alloc-segment" style={{ width: `${a.pct}%`, background: a.color }}></div>
                ))}
              </div>
              {riskData.allocation.map((a, i) => (
                <div key={i} className="alloc-item">
                  <span className="alloc-dot" style={{ background: a.color }}></span>
                  {a.label}
                </div>
              ))}
            </div>
          ...
          <div className="col-12 col-md-6">
            <div className="inv-info-card">
              ...
              <div className="instrument-tags">
                {riskData.instruments.map((inst, idx) => (
                  <span key={idx} className="instrument-tag" style={{ borderColor: riskData.borderColor, color: riskData.borderColor }}>{inst}</span>
                ))}
              </div>
            </div>
          </div>
        ...
        {/* Bottom row: Suitable Goals + Quote */}
        <div className="row g-3 mb-4">
          <div className="col-12 col-md-6">
            <div className="inv-info-card">
              <p className="inv-info-title">Suitable Goals</p>
              {riskData.suitableGoals.map((g, i) => (
                <div key={i} className="suitable-item">
                  <span>{g.icon}</span>
                  <span>{g.text}</span>
                </div>
              ))}
          ...
          <div className="col-12 col-md-6 d-flex">
            <div style={{ background: riskData.quoteColor, borderLeft: `3px solid ${riskData.quoteBorder}`, borderRadius: '0 12px 12px 0', padding: '18px 20px', fontStyle: 'italic', fontSize: '.88rem', lineHeight: 1.6, color: '#1a1d2e', display: 'flex', alignItems: 'center', width: '100%' }}>
              {riskData.quote}
            </div>
          </div>
        </div>
        ...
        <div className="d-flex justify-content-end">
          <button className="btn-primary-action px-5" onClick={() => setShowGoalModal(true)}>
        ...
        <div style={{ background: 'white', borderRadius: '22px', padding: '32px', maxWidth: '640px', width: '90%', maxHeight: '85vh', overflowY: 'auto', boxShadow: '0 24px 64px rgba(0,0,0,.15)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', margin: '20px 0' }}>
            {GOALS_LIST.map(goal => {
              ...
              const statusStyle = goal.status === 'on-track'
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    border: `1.5px solid ${isSelected ? '#3b6eff' : '#e2e6f0'}`,
                ...
                >
                  ...
                  <div style={{
                    ...
                    border: `2px solid ${isSelected ? '#3b6eff' : '#d1d5db'}`,
                    background: isSelected ? 'radial-gradient(circle at center, #3b6eff 45%, #fff 45%)' : 'transparent',
                    transition: 'all .15s ease',
                  }}></div>

                  {/* Goal info */}
                  <div style={{ flex: 1 }}>
                    <p style={{ fontWeight: 700, fontSize: '.95rem', color: '#1a1d2e', margin: '0 0 3px' }}>{goal.name}</p>
                    <p style={{ fontSize: '.82rem', color: '#5c6170', margin: 0 }}>
                      RM {goal.saved.toLocaleString()} / RM {goal.target.toLocaleString()}
                    </p>
                  </div>

                  {/* Status badge */}
                  <span style={{ ...statusStyle, fontSize: '.72rem', fontWeight: 700, borderRadius: '99px', padding: '4px 12px', whiteSpace: 'nowrap' }}>
                    {statusLabel}
                  </span>
                </div>
              );
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
            ...
            <button
              ...
              onClick={() => { setShowGoalModal(false); setShowConfirmModal(true); }}
              style={{ opacity: selectedGoal ? 1 : 0.5, cursor: selectedGoal ? 'pointer' : 'not-allowed' }}
            >
              Continue
            </button>
          </div>
...
const RoiPage = ({ user }) => {
  ...
  const calculateResults = () => {
    ...
    const PMT = formData.monthly;
    const r = formData.rate / 100;
    const t = formData.duration;
    ...
    for (let yr = 0; yr <= t; yr++) {
      ...
      const val = roiMode === 'compound' ? (yr === 0 ? P : calcCompound(P, PMT, r, yr)) : (yr === 0 ? P : calcSimple(P, r, yr));
    ...
    if (chartRef.current) {
      ...
      chartInstance.current = new Chart(chartRef.current, {
        type: 'line',
        data: { labels, datasets: [{ data, borderColor: color, backgroundColor: color + '18', fill: true, tension: 0.4, pointRadius: 4, pointBackgroundColor: color, borderWidth: 2 }] },
        options: {
          responsive: true, maintainAspectRatio: false,
          plugins: { legend: { display: false }, tooltip: { callbacks: { label: ctx => 'RM ' + Math.round(ctx.raw).toLocaleString('en-MY') } } },
          scales: { y: { ticks: { callback: v => 'RM' + (v >= 1000 ? (v / 1000).toFixed(0) + 'k' : v) }, grid: { color: '#e2e6f0' } }, x: { grid: { display: false } } }
        }
      });
    }
  };
  ...
  const calcScenario = (rate) => {
    ...
    const profit = fv - invested;
    const gain = invested > 0 ? ((profit / invested) * 100).toFixed(1) : '0.0';
    return { invested: Math.round(invested), fv: Math.round(fv), profit: Math.round(profit), gain };
  };

  const sA = showResults ? calcScenario(rateA) : null;
  const sB = showResults ? calcScenario(rateB) : null;
  const profitDelta = sA && sB ? sB.profit - sA.profit : 0;
              ...
              <div className="roi-quick-btns mt-2">
                {[3, 5, 7, 9, 12].map(v => (
                  <button key={v} className={`quick-btn ${activeRate === v ? (roiMode === 'compound' ? 'active' : 'active-simple') : ''}`}
                    onClick={() => { setFormData({ ...formData, rate: v }); setActiveRate(v); }}>
                    {v}%
                  </button>
                ))}
              </div>
              ...
              <div className="roi-quick-btns mt-2">
                {[3, 5, 10, 20].map(v => (
                  <button key={v} className={`quick-btn ${activeDuration === v ? (roiMode === 'compound' ? 'active' : 'active-simple') : ''}`}
                    onClick={() => { setFormData({ ...formData, duration: v }); setActiveDuration(v); }}>
                    {v}yr
                  </button>
                ))}
              </div>
          ...
          {showResults && results && (
            <>
              ...
              <div className="roi-card mb-4">
                ...
                {/* ── COMPOUND HINT (Simple mode only) ── */}
                {roiMode === 'simple' && (
                  <div className="compound-hint mt-3">
                    <i className="bi bi-arrow-left-right me-2"></i>
                    <span>
                      Compound earns <strong>RM {Math.max(0, Math.round(calcCompound(formData.principal, formData.monthly, formData.rate / 100, formData.duration) - results.fv)).toLocaleString()}</strong> more on the same initial amount over {formData.duration} years.
                    </span>
                    <button className="hint-link ms-1" onClick={() => setRoiMode('compound')}
                      style={{ background: 'none', border: 'none', padding: 0, cursor: 'pointer', color: '#3b6eff', fontWeight: 600, textDecoration: 'underline' }}>
                      Switch to Compound
                    </button>
                  </div>
                )}
                  ...
                  <div className="col-12 col-sm-6">
                    ...
                    <div className="scenario-card best-scenario">
                      ...
                      <div className="scenario-row">
                        <span>Profit</span>
                        <span><strong style={{ color: '#22c55e' }}>+{fmt(sB.profit)}</strong> {profitDelta > 0 && <span className="profit-delta">+{fmt(profitDelta)}</span>}</span>
                      </div>
                      <div className="scenario-row">
                        <span>Gain</span>
...
const DashboardPage = ({ user }) => {
  ...
  const [dashboardData, setDashboardData] = useState({
    ...
    performance: '+15% Growth',
    riskLevel: 'Moderate',
    riskSub: 'Monitor volatility',
  });
  const [loading, setLoading] = useState(false);
  ...
  const renderCharts = () => {
    ...
    if (trendChartRef.current) {
      trendChartInstance.current = new Chart(trendChartRef.current, {
        ...
        data: {
          ...
          datasets: [{
            data: [4200, 4350, 4205, 4510, 4630, 4585, 4790, 4875],
            borderColor: '#3b6eff',
        ...
        options: {
          ...
          scales: {
            y: {
              min: 0, max: 6000,
              ticks: { stepSize: 1500, color: '#9ca3af', font: { size: 11 } },
    ...
    if (sectorChartRef.current) {
      sectorChartInstance.current = new Chart(sectorChartRef.current, {
        type: 'bar',
        data: {
          labels: ['Tech', 'Health', 'Finance', 'Energy', 'Industrial', 'Consumer'],
          datasets: [{
            data: [15, 8, 5, -2, 6, 4],
        ...
        options: {
          ...
          scales: {
            y: {
              min: -5, max: 15,
              ticks: { stepSize: 5, color: '#9ca3af', font: { size: 11 } },
              grid: { color: 'rgba(148,163,184,0.18)' },
              border: { display: false },
            },
            x: {
  ...
  return (
    <div className="main-content">
      ...
      {/* ── PAGE HEADER ── */}
      <div className="page-header d-flex align-items-center justify-content-between mb-4 flex-wrap gap-3">
        <div>
        ...
        <div className="col-md-4">
          <div className="summary-card dashboard-summary-card">
            <div className="dashboard-card-top">
              <div>
                <p className="summary-label">Market Trend</p>
                <h2 className="summary-value summary-emphasis-green">{dashboardData.trend}</h2>
                <p className="summary-sub">{dashboardData.sp500}</p>
              </div>
              <div className="dashboard-icon-box dashboard-icon-trend">
          ...
          <div className="summary-card dashboard-summary-card">
            <div className="dashboard-card-top">
              <div>
                ...
                <h2 className="summary-value summary-emphasis-green">{dashboardData.topPerformer}</h2>
                <p className="summary-sub">{dashboardData.performance}</p>
              </div>
              <div className="dashboard-icon-box dashboard-icon-performer">
          ...
          <div className="summary-card dashboard-summary-card">
            <div className="dashboard-card-top">
              <div>
                ...
                <h2 className="summary-value summary-emphasis-dark">{dashboardData.riskLevel}</h2>
                <p className="summary-sub">{dashboardData.riskSub}</p>
              </div>
              <div className="dashboard-icon-box dashboard-icon-risk">
      ...
      {/* ── API-DRIVEN SUMMARY PANEL ── */}
      <div className="dashboard-panel api-summary-panel mb-4">
        ...
        <div className="dashboard-summary-grid">
          ...
          <div className="dashboard-summary-item">
            ...
            <strong className="insight-value dashboard-performance-value">
              {dashboardData.performance.replace(' Growth', '')}
            </strong>
          </div>
        </div>
      ...
      {/* ── FINANCIAL NEWS ── */}
      <div className="dashboard-section-block mb-4">
        ...
        <div className="dashboard-news-list">
          <article className="news-card">
            <div className="news-thumb news-thumb--1"></div>
            <div className="news-content">
              <h3 className="news-title">Tech Stocks Rally as AI Innovation Continues to Drive Growth</h3>
          ...
          <article className="news-card">
            <div className="news-thumb news-thumb--2"></div>
            <div className="news-content">
              <h3 className="news-title">S&amp;P 500 Reaches New Heights Amid Strong Economic Data</h3>
              <div className="news-meta">
          ...
          <article className="news-card">
            <div className="news-thumb news-thumb--3"></div>
            <div className="news-content">
              <h3 className="news-title">Federal Reserve Signals Cautious Approach to Interest Rate Changes</h3>
              <div className="news-meta">
      ...
      <div className="dashboard-panel recommendations-panel">
        ...
        <div className="dashboard-action-list">
          <div className="recommendation-item">
            ...
            <div>
              <h4>Stay Aggressive</h4>
              <p>Market trend is bullish. Consider increasing exposure to growth stocks.</p>
            </div>
          </div>
          ...
          <div className="recommendation-item warning">
            ...
            <div>
              <h4>Compare Portfolio Allocation</h4>
              <p>Review your current allocation against tech stocks.</p>
            </div>
          </div>
          ...
          <div className="recommendation-item">
            ...
            <div>
              <h4>Review Risk Level</h4>
              <p>Current market volatility is moderate. Assess your risk tolerance before investing.</p>
            </div>
          </div>
          ...
          <div className="recommendation-item warning">
            ...
            <div>
              <h4>Monitor Tech Sector</h4>
              <p>
                Tech Stocks showing strong performance ({dashboardData.performance.replace(' Growth', '')}).
...
const ProtectedRoute = ({ children, user }) => {
  ...
  return user_stored?.email ? children : <Navigate to="/login" />;
};
...
// Wrap App with Router in main.jsx:
